...
#ifndef SLN_LOCAL_VOICE_MODEL_H_
#define SLN_LOCAL_VOICE_MODEL_H_

extern unsigned int oob_demo_en_begin;
extern unsigned int oob_demo_zh_begin;
extern unsigned int oob_demo_de_begin;
